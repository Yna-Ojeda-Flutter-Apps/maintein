...
class $GoalsTable extends Goals with TableInfo<$GoalsTable, Goal> {
  ...
  List<GeneratedColumn> get $columns =>
      [id, dateCreated, urgency, task, completed, dueDate, dateCompleted];
  @override
...
class $SubTasksTable extends SubTasks with TableInfo<$SubTasksTable, SubTask> {
  ...
  @override
  List<GeneratedColumn> get $columns => [sId, dateCreated, id, task, completed];
  @override
...
class $OutputsTable extends Outputs with TableInfo<$OutputsTable, Output> {
  ...
  @override
  List<GeneratedColumn> get $columns => [oId, dateCreated, id, item, completed];
  @override
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  CollectorDao get collectorDao =>
      _collectorDao ??= CollectorDao(this as AppDatabase);
  @override
...
mixin _$CollectorDaoMixin on DatabaseAccessor<AppDatabase> {
  $GoalsTable get goals => db.goals;
  $SubTasksTable get subTasks => db.subTasks;
  $OutputsTable get outputs => db.outputs;
  $JournalsTable get journals => db.journals;
